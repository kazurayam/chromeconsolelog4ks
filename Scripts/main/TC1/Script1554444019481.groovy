...
WebDriver driver = new ChromeDriverFactory().openChromeDriver(FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_txt_visit_date'), 
    '31/12/2029')
